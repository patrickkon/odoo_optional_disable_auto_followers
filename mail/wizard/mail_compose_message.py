...
class mail_compose_message(osv.TransientModel):
    ...
    def send_mail(self, cr, uid, ids, context=None):
        ...
        enable_automatic_followers = self.pool['ir.config_parameter'].get_param(cr, uid, "enable_automatic_followers", context=context)
        if not enable_automatic_followers and not context.get('manual_add_followers', False):
